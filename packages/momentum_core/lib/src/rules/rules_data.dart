...
const List<RuleEntry> padelRules = [
  ...
  RuleEntry(
    id: 'serve_choice',
    question: 'Chi decide chi serve per primo e da che lato si inizia?',
    answer:
        'Lo decide il sorteggio. La coppia che vince il lancio della moneta '
        'sceglie una fra tre opzioni: servire o ricevere per prima, e allora '
        'gli avversari scelgono il lato; oppure il lato per il primo game, e '
        'allora gli avversari scelgono se servire o ricevere; oppure può '
        'chiedere agli avversari di scegliere per primi. Stabiliti ordine di '
        'servizio e lati, entrambe le coppie comunicano all\'arbitro chi '
        'servirà e chi riceverà per primo.',
    keywords: [
      'sorteggio',
      'moneta',
      'chi serve',
    ...
    source: '$_fip — Regola 4, Scelta dei lati e del servizio',
    ruleRef: 'Regola 4, punti 1-2',
    example:
        'Vinci il sorteggio e scegli di servire: gli avversari scelgono da '
        'quale lato del campo iniziare.',
  ),
  RuleEntry(
    id: 'serve_how',
