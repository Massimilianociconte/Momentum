...
class PaywallScreen extends ConsumerWidget {
  ...
  Widget _planCard(
    ...
    // Il prezzo mostrato deve sempre essere quello dello store (valuta e
    // importo localizzati). Il listino interno `plan.monthlyEur` è in EUR e in
    // un altro mercato mostrerebbe un importo diverso da quello addebitato:
    // "price shown differs from price charged" è un rigetto ricorrente
    // (App Review 3.1.2, Play Subscriptions). Senza dato dallo store il
    // pulsante è già disabilitato, quindi qui si mostra un segnaposto.
    final price = info?.displayPrice ?? '—';
