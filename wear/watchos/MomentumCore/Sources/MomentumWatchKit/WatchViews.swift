...
public struct MomentumWatchAppRoot: View {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 8) {
                ...
                Text("Consultazione locale, disponibile anche senza rete.")
                    .font(.system(size: 9, weight: .medium, design: .rounded))
                    .foregroundStyle(.white.opacity(0.58))
                // AI Act (Reg. UE 2024/1689) art. 50 §1, applicabile dal
                // 2026-08-02: chi interagisce con un sistema di IA deve
                // esserne informato. Il nome della mascotte non lo rende
                // "ovvio", quindi la disclosure precede ogni risposta generata.
                Text(WatchAssistantDisclosure.text)
                    .font(.system(size: 9, weight: .medium, design: .rounded))
                    .foregroundStyle(.white.opacity(0.58))
                    .fixedSize(horizontal: false, vertical: true)
