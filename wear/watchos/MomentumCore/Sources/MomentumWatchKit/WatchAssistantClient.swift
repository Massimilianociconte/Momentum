...
///
/// Reg. UE 2024/1689 (AI Act) art. 50 §1, applicabile dal 2 agosto 2026: chi
/// interagisce direttamente con un sistema di IA deve esserne informato,
/// "unless this is obvious" — il nome della mascotte non basta. Il testo deve
/// restare allineato a `AppBrand.assistantAiDisclosureShort` (telefono) e a
/// `AI_DISCLOSURE` (Wear OS).
public enum WatchAssistantDisclosure {
    public static let text = "Risposte generate da IA: possono contenere errori."
}
