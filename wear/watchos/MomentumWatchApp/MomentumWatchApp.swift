#if canImport(MomentumWatchKit)
import MomentumWatchKit
#endif
...
final class MomentumWatchAppDelegate: NSObject, WKApplicationDelegate {
...
struct MomentumWatchApp: App {
    @WKApplicationDelegateAdaptor private var appDelegate: MomentumWatchAppDelegate

    var body: some Scene {
        WindowGroup {
            MomentumWatchAppRoot()
        }
    }
}
